...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2025 a las 21:49:56
...
CREATE TABLE `cotizaciones` (
  ...
  `data_repuestos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci NOT NULL
...
INSERT INTO `cotizaciones` (`id`, `id_users`, `departamento`, `nombre_cliente`, `modelo_carro`, `año_carro`, `placa_carro`, `vin_carro`, `data_repuestos`) VALUES
...
(2, 'Miguel', 'Ticaray', 'miguelticaray@gmail.com', '$2y$10$O4igYxv7X3a8BKpOyxFULucZCNmXhD4l9uT1i7gEaOxhqYFSMfO3O', 'Soporte Tecnico', 'Informatica', 'admin'),
(3, 'Aurelis', 'Dommar', 'aurelisdc21@gmail.com', '$2y$10$iSRsmwjoBhib6buD8iLXBe.lb.LvLqdKY7G.XEDFSwlCF8Q2KkMJW', 'Soporte Tecnico', 'Desarrollo', 'admin');
